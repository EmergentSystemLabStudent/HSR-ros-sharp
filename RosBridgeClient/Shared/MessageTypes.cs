...
namespace RosSharp.RosBridgeClient
{
    public static class MessageTypes
    {
        public static readonly Dictionary<string, Type> Dictionary = new Dictionary<string, Type>
        {
            ...
            { "visualization_msgs/Marker", typeof (Marker)},
            { "visualization_msgs/MarkerArray", typeof (MarkerArray) },
            { "darknet_ros_msgs/BoundingBoxes",typeof(BoundingBoxes)},  //add
            { "darknet_ros_msgs/BoundingBox",typeof(BoundingBox) },   //add

            {"std_msgs/Int32",typeof(int32) },    //add

            { "std_msgs/ColorRGBA", typeof (ColorRGBA) }
        };
